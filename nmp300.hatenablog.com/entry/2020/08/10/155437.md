...
そのアプリとは、フィヨルドブートキャンプ受講生が日頃学習に使っているeラーニングアプリです。
...
そして、以下が、私が作成したPRです。現在は他の受講生の方が実装したコードもマージされている状態です。  
...
ActionCableとVue.jsを使用して、上記のリアルタイムでCRUDができる分報機能を実装しました。

大きな機能だったため、私は最小限の機能の実装し、大枠を作ってその他必要な機能の追加は他の受講生の方に任せたという運びです。
